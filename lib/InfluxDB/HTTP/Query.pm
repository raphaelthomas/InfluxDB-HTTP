...
InfluxDB::HTTP::Query - The great new InfluxDB::HTTP::Query!
...
Perhaps a little code snippet.
    ...
    use InfluxDB::HTTP::Query;

    my $foo = InfluxDB::HTTP::Query->new();
    ...
